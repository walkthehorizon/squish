...
3. **访问地址**  
   发布成功后地址为：  
   `https://walkthehorizon.github.io/`
   - 隐私政策（中文）：`.../squish/static/privacy-policy.html`  
   - 隐私政策（英文）：`.../squish/static/privacy-policy-en.html`  
   - 用户协议（中文）：`.../squish/static/user-agreement.html`  
   - 用户协议（英文）：`.../squish/static/user-agreement-en.html`
